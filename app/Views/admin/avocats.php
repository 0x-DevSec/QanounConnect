...
<head>
    <meta charset="UTF-8">
    <title>Gestion des Avocats | Admin</title>
...
<div class="d-flex">
    ...
    <aside class="sidebar p-4">
        ...
        <ul class="nav flex-column gap-1">
            ...
            <li><a class="nav-link active rounded px-3 py-2" href="#"><i class="fa-solid fa-user-tie me-2"></i> Avocats</a></li>
            <li><a class="nav-link rounded px-3 py-2" href="huissiers.php"><i class="fa-solid fa-gavel me-2"></i> Huissiers</a></li>
        </ul>
    </aside>
    ...
    <main class="flex-grow-1 p-4">
        <div class="d-flex justify-content-between mb-4">
            <h2 class="fw-bold">Gestion des Avocats</h2>
            <button class="btn btn-dark">
                <i class="fa-solid fa-plus me-1"></i> Ajouter un avocat
            </button>
        </div>
